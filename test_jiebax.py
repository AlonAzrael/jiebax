...
百度搜索公司总裁向海龙表示，百度坚决拥护调查组的整改要求，深刻反思自身问题，绝不打一丝折扣。“百度应该提供更加优质、可靠的搜索服务。”“则西同学不幸离世，在社会上引起了巨大反响，也给百度带来极大触动，引发百度全员重新审视作为一家搜索引擎公司的责任。”
...
向海龙表示，此次联合调查组进驻，给予百度很多业务指导意见，帮助我们审视问题、改进管理。这次整改会对百度的短期利益造成影响，但我们相信在调查组的指导下，百度和搜索引擎行业能够实现更健康的发展，广大网民的权益会得到更好的保障，还将大力推动医疗服务质量的提升。
“百度最新成立搜索公司，有信心、有决心以此为新征程、新起点，与不良信息进行长期的坚决斗争，为广大用户提供更简单、更便捷、更值得依赖的搜索服务。”向海龙表示。
"""
...
if __name__ == '__main__':
    ...
    # words = cut_benchmark(x_flag=False, posseg_flag=True)
